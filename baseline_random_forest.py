...
=========================
Baseline Random Forest classifier for household COVID-19
secondary transmission risk prediction.

Trains a Random Forest (n_estimators=200, max_depth=15) classifier on the stratified k-fold datasets produced by
...
for fold in range(1, 6):
    ...
    features_path = os.path.join(output_dir, f'rf_features_fold_{fold}.json')
